...
// Query for Men's clothing ranked by price high to low
...
<head>
  ...
  <title>Men's Collection - Cloth Rental</title>
...
<header>
  ...
  <div class="search-bar-wrapper">
    <form action="men.php" method="GET" class="search-form">
      <input type="text" name="search" placeholder="Search Men's Clothing" value="<?php echo htmlspecialchars($search); ?>" />
