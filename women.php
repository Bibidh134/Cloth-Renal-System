...
// Query for Wmen's clothing ranked by price high to low
...
// Add high-to-low price ranking
$query .= " ORDER BY ci.price DESC";
...
<head>
  ...
  <title>Women's Collection - Cloth Rental</title>
...
<body>
  ...
  <header>
    ...
    <div class="search-bar-wrapper">
      <form action="women.php" method="GET" class="search-form">
        <input type="text" name="search" placeholder="Search Women's Clothing" value="<?php echo htmlspecialchars($search); ?>" />
        <button type="submit"><i class="fas fa-search"></i> Search</button>
      </form>
      <div class="search-cart-container">
        <a href="cart_view.php" title="View Cart">
  ...
  <section class="hero1">
    <h1>Women Fashion Collection</h1>
     <p>Ranked by Price: High to Low</p>
  </section>
  ...
  <section class="category-section">
    <div class="category-container">
      <?php if ($result->num_rows > 0): ?>
        ...
        <?php endwhile; ?>
      <?php else: ?>
        <p>No women's clothing items available.</p>
      <?php endif; ?>
    </div>
  </section>
